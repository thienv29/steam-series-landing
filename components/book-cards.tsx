...
const mathBooks = [
  {
    ...
    title: 'Math Book 1',
    documentUrl: '/pdf/steam-series-fun-with-math-1.pdf',
  },
  {
    id: 2,
    image: '/bo-sach/math-2.jpg',
    title: 'Math Book 2',
    documentUrl: '/pdf/steam-series-fun-with-math-2.pdf',
  },
  {
    id: 3,
    image: '/bo-sach/math-3.jpg',
    title: 'Math Book 3',
    documentUrl: '/pdf/steam-series-fun-with-math-3.pdf',
  },
  {
    id: 4,
    image: '/bo-sach/math-4.jpg',
    title: 'Math Book 4',
    documentUrl: '/pdf/steam-series-fun-with-math-4.pdf',
  },
  {
    id: 5,
    image: '/bo-sach/math-5.jpg',
    title: 'Math Book 5',
    documentUrl: '/pdf/steam-series-fun-with-math-5.pdf',
  },
]
...
const scienceBooks = [
  {
    ...
    documentUrl: '/pdf/steam-series-fun-with-science-1wtm.pdf',
  },
  {
    id: 2,
    image: '/bo-sach/science-2.jpg',
    title: 'Science Book 2',
    documentUrl: '/pdf/steam-series-fun-with-science-2wtm.pdf',
  },
  {
    id: 3,
    image: '/bo-sach/science-3.jpg',
    title: 'Science Book 3',
    documentUrl: '/pdf/steam-series-fun-with-science-3wtm.pdf',
  },
  {
    id: 4,
    image: '/bo-sach/science-4.jpg',
    title: 'Science Book 4',
    documentUrl: '/pdf/steam-series-fun-with-science-4wtm.pdf',
  },
  {
    id: 5,
    image: '/bo-sach/science-5.jpg',
    title: 'Science Book 5',
    documentUrl: '/pdf/steam-series-fun-with-science-5wtm.pdf',
  },
]
